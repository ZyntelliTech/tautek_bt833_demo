...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_TAUTEK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS3MDL_TRIGGER_GLOBAL_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS3MDL_TRIGGER, 1);
